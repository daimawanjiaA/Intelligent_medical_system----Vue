...
<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="治疗结果" prop="result" align="center" width="100">
        <!-- <template slot-scope="{row}">
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      <el-form ref="dataForm" :rules="rules" :model="mrs" label-position="left" label-width="70px" style="width: 400px; margin-left:50px;">
        ...
        <el-form-item label="医生号" prop="Dno">
          <el-input v-model="Dno" :disabled="disabled" />
        </el-form-item>
...
export default {
  ...
  created() {
    this.role = window.localStorage.getItem('DDno')
    if (this.role === 'admin') { this.show = true }
    this.getList()
  ...
  methods: {
    ...
    getList() {
      this.listLoading = true
      this.$http.get('/mr/selectMr_P_DByDno?Dno=' + this.role).then((response) => {
